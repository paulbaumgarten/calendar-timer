...
function ticktock() {
	...
	document.querySelector(".clock-date").innerHTML = new Date(timestamp*1000).toLocaleDateString();
	document.querySelector(".clock-time").innerHTML = timeStringToHHMMSS(new Date(timestamp*1000).toLocaleTimeString());
